...
public class AdditionalLinkTest {
    ...
    @Test
    void testCreation() {
        final AdditionalLink additionalLink = new AdditionalLink(1, TEST_URL, TEST_DESCRIPTION, TEST_DESCRIPTION_CY, TEST_TYPE, TEST_SIDEBAR_LOCATION);
        ...
        softly.assertThat(additionalLink.getType()).isEqualTo(TEST_TYPE);
        softly.assertAll();
    }
}
