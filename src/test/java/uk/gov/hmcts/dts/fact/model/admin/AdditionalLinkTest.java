...
public class AdditionalLinkTest {
    ...
    void testCreation() {
        ...
        final uk.gov.hmcts.dts.fact.entity.AdditionalLink additionalLinkEntity = new uk.gov.hmcts.dts.fact.entity.AdditionalLink(TEST_URL, TEST_DESCRIPTION, TEST_DESCRIPTION_CY, sidebarLocation);
        ...
        softly.assertThat(result.getDescription()).isEqualTo(TEST_DESCRIPTION);
        softly.assertThat(result.getDescriptionCy()).isEqualTo(TEST_DESCRIPTION_CY);
