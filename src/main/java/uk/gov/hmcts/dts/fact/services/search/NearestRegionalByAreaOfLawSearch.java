...
@Component
public class NearestRegionalByAreaOfLawSearch implements Search {

    private final CourtWithDistanceRepository courtWithDistanceRepository;

    public NearestRegionalByAreaOfLawSearch(final CourtWithDistanceRepository courtWithDistanceRepository) {
