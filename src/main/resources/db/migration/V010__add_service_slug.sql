...
COPY public.search_service (id, name, description, name_cy, description_cy, slug) FROM stdin;
1	Money	Money claims, rent or mortgage disputes, bankruptcy, job disputes related to pay, appealing a tax or benefits decision.			money
2	Probate, divorce or ending civil partnerships	Probate application and disputes, divorce, ending a civil partnership.			probate-divorce-or-ending-civil-partnerships
3	Childcare and parenting	Arrangements for looking after your children if you separate from your partner or making an adoption legal.			childcare-and-parenting
4	Harm and abuse	Applying for an injunction against someone who is harassing or abusing you, being made to marry against your will or preventing Female Genital Mutilation (FGM).			harm-and-abuse
5	Immigration and asylum	Seeking asylum, right to live in the UK, and appealing deportation.			immigration-and-asylum
6	Crime	Minor criminal fines for TV licenses or speeding, major criminal cases at a Crown or Magistrates’ Court.			crime
7	High Court district registries	Courts that deal with the most serious and high profile cases in criminal and civil law.			high-court-district-registries
\.
