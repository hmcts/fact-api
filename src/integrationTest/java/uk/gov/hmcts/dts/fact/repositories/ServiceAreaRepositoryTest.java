...
public class ServiceAreaRepositoryTest {
    ...
    void shouldNotFindNonExistentService() {
        final Optional<uk.gov.hmcts.dts.fact.entity.ServiceArea> result = serviceAreaRepository.findBySlugIgnoreCase("nonExistent");
    ...
    void shouldHandleNull() {
        final Optional<uk.gov.hmcts.dts.fact.entity.ServiceArea> result = serviceAreaRepository.findBySlugIgnoreCase(null);
        assertThat(result).isEmpty();
    }
}
