...
class CourtHistoryRepositoryTest {
    ...
    private static final String DATE2 = "2024-02-03T10:15:31";
    ...
    private final CourtHistory courtHistory2 = new CourtHistory(
            null, 1479805, OLD_COURT_NAME, LocalDateTime.parse(DATE2), LocalDateTime.parse(DATE), null);
    private final CourtHistory courtHistory3 = new CourtHistory(
            null, 1479802, "fakeCourt3", LocalDateTime.parse(DATE),
            LocalDateTime.parse(DATE), "");
    private final CourtHistory courtHistory4 = new CourtHistory(
            null, 1479802, "fakeCourt4", LocalDateTime.parse(DATE),
    ...
    void shouldReturnCourtHistoriesThatMatchTheGivenNameIgnoringCase() {
        ...
        assertThat(courtHistoryRepository.findAllByCourtNameIgnoreCaseOrderByUpdatedAtDesc("old NEAth courT"))
            .hasSize(2)
            .satisfiesExactly(
                savedCourtHistoryItem1 ->
                    assertThat(savedCourtHistoryItem1.getCourtName()).isEqualTo(OLD_COURT_NAME),
    ...
    @Test
    void shouldReturnCourtHistoriesThatMatchTheGivenNameMostRecentlyUpdatedFirst() {
        courtHistoryRepository.save(courtHistory1);
        courtHistoryRepository.save(courtHistory2);
        courtHistoryRepository.save(courtHistory3);
        ...
        assertThat(courtHistoryRepository.findAllByCourtNameIgnoreCaseOrderByUpdatedAtDesc("old NEAth courT"))
            ...
            .satisfiesExactly(
                savedCourtHistoryItem1 ->
                    assertThat(savedCourtHistoryItem1.getUpdatedAt()).isEqualTo(LocalDateTime.parse(DATE2)),
                savedCourtHistoryItem2 ->
                    assertThat(savedCourtHistoryItem2.getUpdatedAt()).isEqualTo(LocalDateTime.parse(DATE))
            );
    }
